...
구현이 아니라 for 문 두번 돌리니까 타임에러가 난… 문제 .. sort 에 if 를 집어 넣을 수 있는지 몰랐다. 개념상 람다니까 가능한 건데 왜 생각을 못했는지 .. 그것 만 떠올린 다면 쉬웠던 문제  !
괜히 아스키 까지 고려 해서 복잡 하게 생각했다.
