...
거리가 가장 짧은걸 구할때는 중간 위치를 생각하자 ! 

어떤 정렬을 써도 안되서 재귀로 루프 돌려볼까 .. ? 생각했는데, 생각해보니 결국 루프 두번 돌리는 꼴이라 , 

스택 메모리 만 더 잡아 먹는 방식 으로 코드 를 쓴 것 같다…
