...
뭐지 ? 왜잘하지 ? 골든데 흠.. 그냥 기본유형 이었나 ? 근데 정말 기본 유형이긴 하다 . 

크게 설명할 건 없고 전체에 3개의 장애물을 설치하고 s와 마주치는지 확인해야 해서 하나는 dfs, 하나는 체크 함수

로 하나라도 ture 면 Yes 가 나오도록 구현했다.
